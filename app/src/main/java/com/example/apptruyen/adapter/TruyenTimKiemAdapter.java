...
public class TruyenTimKiemAdapter extends RecyclerView.Adapter<TruyenTimKiemAdapter.ViewHolder>{
    ...
    public TruyenTimKiemAdapter(List<Truyen> truyenList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_sreach, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtItemTenTruyenSreach.setText(truyen.getTenTruyen());
        holder.txtSoChuong.setText("Số Chương: "+truyen.getSoChuong());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot postSnapshot: snapshot.getChildren()) {
                    ...
                    if(user.getId().equals(truyen.getTacGia())){
                        holder.txtItemTacGiaSreach.setText(user.getTen());
                    }
                }
            }
            @Override
        ...
        storageRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                ...
                Glide.with(holder.itemView.getContext()) // Sử dụng ApplicationContext hoặc Activity.this
                        ...
                        .into(holder.imageViewSreach);
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception exception) {
                holder.imageViewSreach.setImageResource(R.drawable.default_book_cover_2);
    ...
    public void addAll(ArrayList<Truyen> filteredData) {
        truyenList.clear();
        truyenList.addAll(filteredData);
        notifyDataSetChanged();
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        private ImageView imageViewSreach;
        private TextView txtItemTenTruyenSreach, txtItemTacGiaSreach, txtSoChuong;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txtItemTenTruyenSreach = itemView.findViewById(R.id.txtItemTenTruyenSreach);
            txtItemTacGiaSreach = itemView.findViewById(R.id.txtItemTacGiaSreach);
            imageViewSreach = itemView.findViewById(R.id.imageViewSreach);
