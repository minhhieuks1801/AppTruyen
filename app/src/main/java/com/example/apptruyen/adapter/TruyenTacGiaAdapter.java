...
public class TruyenTacGiaAdapter extends RecyclerView.Adapter<TruyenTacGiaAdapter.ViewHolder> {

    private List<Truyen> truyenList;
    private IClickListener iClickListener;
    public interface IClickListener{
        void onClickSuaItem(Truyen truyen);
        void onClickXoaItem(Truyen truyen);
    }

    public TruyenTacGiaAdapter(List<Truyen> truyenList, IClickListener iClickListener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_item_truyensangtac, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnSuaItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                iClickListener.onClickSuaItem(truyen);
            }
        });

        holder.btnXoaItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                iClickListener.onClickXoaItem(truyen);
            }
        });
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private Button btnSuaItem, btnXoaItem;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            txtItemTenTruyenTT = itemView.findViewById(R.id.txtItemTenTruyenTG);
            txtItemTacGiaTT = itemView.findViewById(R.id.txtItemTacGiaTG);
            imgItemBiaTruyenTT = itemView.findViewById(R.id.imgItemBiaTruyenTG);
            btnSuaItem = itemView.findViewById(R.id.btnSuaItem);
            btnXoaItem = itemView.findViewById(R.id.btnXoaItem);
        }
    }
}
